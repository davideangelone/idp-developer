...
class ClientCredentialsTest extends AbstractIdpIntegrationMockMvcTest {
    ...
    void clientCredentials_returnsAccessToken() throws Exception {
        MvcResult result = mockMvc.perform(post("/oauth2/token")
                        .with(httpBasic(appProperties.getOauth2Client().getClientId(), appProperties.getOauth2Client().getClientSecret()))
        ...
        assertThat(claims.getSubject()).isEqualTo(appProperties.getOauth2Client().getClientId());
